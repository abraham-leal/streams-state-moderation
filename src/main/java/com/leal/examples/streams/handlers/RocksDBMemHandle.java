...
public class RocksDBMemHandle implements RocksDBConfigSetter {
    ...
    Pass in:
     ...
     - Number of bits for shardID (-1 lets the system decide)
     - Whether an insert should fail if the memory is full
     - The ratio of memory reserved for index and bloom filter tables
     */
    private static org.rocksdb.Cache cache = new org.rocksdb.LRUCache(100 * 1024 * 1024L, -1, false, 0.25);
    ...
    public void setConfig(String s, Options options, Map<String, Object> map) {
        // Universal compaction is used by default
         ...
         */
        // Count index and filter blocks against block cache
        tableConfig.setCacheIndexAndFilterBlocks(true);
        // Set index and filter as "high priority"
        tableConfig.setCacheIndexAndFilterBlocksWithHighPriority(true);
        // Do not evict index and filter blocks
        tableConfig.setPinTopLevelIndexAndFilter(true);
        // Do not evict l0 data
